Anisible is one of my favorite tools for both automating different server/worksation configurations and to administrate multiple servers all at the same time from a single source. 
