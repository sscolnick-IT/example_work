# This is a bash script I created to feed a list of txt2image prompts into stable diffusion
# format of the prompt list text file: '[text2img prompts]'~[file names] 
#the list should be newline separated for each prompt. 
